          ...
          <div className="fr-col-offset-lg-2 fr-col-12 fr-col-md-8 fr-col-lg-6">
            <h2 className="fr-mt-5w fr-mt-9v">
              ...
              <p className="siret-structure">
                SIRET: {structure?.structure?.siret ? structure?.structure?.siret : 'non renseigné'}<br />
                <strong>ID: {structure?.structure?.idPG ? structure?.structure?.idPG : 'non disponible'}</strong>
              </p>
            </h2>
          </div>
